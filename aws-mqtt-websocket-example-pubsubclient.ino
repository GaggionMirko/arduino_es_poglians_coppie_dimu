...
char wifi_ssid[]       = "supermariobalotedua";
char wifi_password[]   = "Az-stozzoca";
char aws_endpoint[]    = "a1yw4ds2w5dem1-ats.iot.eu-central-1.amazonaws.com";
char aws_key[]         = "AKIAQW5P5LBNDLDPXFFG";
char aws_secret[]      = "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";
char aws_region[]      = "eu-central-1";
const char* aws_topic  = "dimuTest";
int port = 443;
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  {
    if(((char)payload[i]=='n')&&((char)payload[i+1]=='u')&&((char)payload[i+2]=='l')&&((char)payload[i+3]=='l')){//condizione scritta male e superficiale
      gianni_vuoto = 1;
    }else{
  ...
  if (comando.equals("ull")){
    
  }else{

Serial.println("gradi registrati: " +comando);
int num;
num=comando.toInt();
  ...
  if(num<21){ //accendi
    ...
    if(num>21){ //spegni, non serve condizione ma vabbo'
